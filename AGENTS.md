...
This project is indexed by GitNexus as **RevitDevTool** (13582 symbols, 35525 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
