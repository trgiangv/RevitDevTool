...
```powershell
dotnet test tests/DevTools.Mcp.Tests --filter "FullyQualifiedName~InvokeDynamicSdkHarness|StructuredOutput|ToolsetResultSerializer|RevitMcpToolSetParser|ContractTests"
```
