...
See [`docs/architecture/MCP/tools.md`](../architecture/MCP/tools.md) for the full catalog of tools, resources, and prompts.
...
- MCP protocol docs: `docs/architecture/MCP/README.md`
- Transport & daemon: `docs/architecture/MCP/transport.md`, `docs/architecture/MCP/daemon.md`
