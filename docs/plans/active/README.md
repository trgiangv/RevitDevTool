...
| P1 | [0020](../../decisions/0020-framework-neutral-mtp-host-testing.md) | [Framework-neutral testing core](2026-08-17-p1-framework-neutral-testing-core.md) | Tasks 1-8 + `testing/*` stdout cutover; NUnit parity unblocks P2 |
| P2 | [0021](../../decisions/0021-xunit4-host-testing-provider.md) | [xUnit 4 host provider](2026-08-17-p2-xunit4-host-provider.md) | Unblocked — start after P1 cutover commit |
