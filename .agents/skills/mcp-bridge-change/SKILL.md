...
- Read `docs/ai/mcp-pytest-bridge.md` and `docs/MCP/README.md`.
...
- Update `docs/MCP/README.md` or `docs/ai/mcp-pytest-bridge.md` when changing MCP architecture, registry flow, protocol shape, or dispatch behavior.
