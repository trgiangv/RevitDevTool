# RevitDevTool.PyDemo - Advanced BIM Dashboard
...
```powershell
cd source/RevitDevTool.PyDemo/dashboard-ui
npm install
```
...
`source/RevitDevTool.PyDemo/dashboard-ui/dist`
