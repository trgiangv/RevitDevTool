...
[MemoryDiagnoser]
public class ComboAppendBenchmarks
{
    private const int BatchSize = 2000;
    private readonly IReadOnlyList<string> _messages =
        ScenarioDataFactory.BuildMessages(BatchSize, 256, TokenDensity.None, structuredPayload: false);
    ...
    public void Setup()
    {
        ...
        _zloggerScintillaLogger = _zloggerScintillaFactory.CreateLogger("Bench.ZLogger.Scintilla.Append");
    }
    ...
    [Benchmark(Baseline = true, Description = "Serilog + RichTextBox append")]
    public int SerilogRichText_Append()
    {
    ...
    [Benchmark(Description = "ZLogger + Scintilla append")]
    public int ZLoggerScintilla_Append()
    {
        for (var i = 0; i < _messages.Count; i++)
