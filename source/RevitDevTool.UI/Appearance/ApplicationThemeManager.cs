...
public static class ApplicationThemeManager
{
    ...
    internal const string LibraryNamespace = "revitdevtool.ui;";

    public const string ThemesDictionaryPath = "pack://application:,,,/RevitDevTool.UI;component/Resources/Theme/";
