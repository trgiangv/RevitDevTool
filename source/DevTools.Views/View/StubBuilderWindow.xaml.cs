...
public partial class StubBuilderWindow
{
    ...
    private void OnThemeChanged(object? sender, EventArgs e) => ApplyTheme(ThemeManager.Current.ActualApplicationTheme);
    private void ApplyTheme(AppTheme theme) => this.SetTitleBarTheme(theme == AppTheme.Dark);
    private void OnClosed(object? sender, EventArgs e) => ThemeManager.Current.ActualApplicationThemeChanged -= OnThemeChanged;
