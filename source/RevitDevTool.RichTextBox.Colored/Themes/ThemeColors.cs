...
public static class ThemeColors
{
    ...
    public static readonly Color DarkBackground = ColorTranslator.FromHtml("#1E1E1E");
    public static readonly Color LightBackground = ColorTranslator.FromHtml("#FFFFFF");
}