...
public sealed class DotnetMcpServerPrimitiveAdapter(
    ...
    IServiceProvider serviceProvider) : IMcpServerPrimitiveAdapter
{
    ...
    public McpServerTool? CreateTool(McpRegisteredTool registration) => DotnetMcpServerFactory.GetOrCreate(
    ...
    public McpServerPrompt? CreatePrompt(McpRegisteredPrompt registration) => DotnetMcpServerFactory.GetOrCreate(
    ...
    public McpServerResource? CreateResource(McpRegisteredResource registration) => DotnetMcpServerFactory.GetOrCreate(
