...
using RevitDevTool.Logger.Utils;

namespace RevitDevTool.Logger.Listeners;

/// <summary>
/// Host-agnostic trace listener writing to ILoggerAdapter.
/// </summary>
public class LoggerTraceListener : TraceListener
{
    ...
    private readonly LogConfigCore _options;
    private readonly bool _enableJsonSerialization;
    ...
    public LoggerTraceListener(ILoggerAdapter logger, LogConfigCore options)
    {
        _logger = logger.ForContext<LoggerTraceListener>();
        _options = options ?? throw new ArgumentNullException(nameof(options));
        _enableJsonSerialization = options.EnablePrettyJson;
