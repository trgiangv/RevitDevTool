...
{
    public static Result RunCommand(CommandItem commandItem, ExternalCommandData data, ref string message, ElementSet elements)
    {
#if NET
        var filePath = commandItem.AssemblyPath;
        var alc = new CommandLoadContext(filePath);

        try
        {
            return ExecuteInIsolatedContext(alc, commandItem, data, ref message, elements);
        }
        finally
        {
            alc.Unload();
        ...
        try
        {
            ...
            return ExecuteInCurrentAppDomain(commandItem, data, ref message, elements);
        }
        finally
        {
            RevitContext.Application.PurgeReleasedAPIObjects();
    ...
    private static Result ExecuteInIsolatedContext(CommandLoadContext alc, CommandItem item, ExternalCommandData data, ref string message, ElementSet elements)
    {
