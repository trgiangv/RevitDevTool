...
public static partial class RibbonExtensions
{
    ...
    /// <summary>
    ///     Retrieves the internal <see cref="Autodesk.Windows.RibbonItem"/> instance associated with the specified <see cref="Autodesk.Revit.UI.RibbonItem"/>.
    ///     This method uses reflection to access the private field "m_RibbonItem" within the provided <see cref="Autodesk.Revit.UI.RibbonItem"/>.
    /// </summary>
    /// <param name="ribbonItem">The <see cref="Autodesk.Revit.UI.RibbonItem"/> to extract the internal <see cref="Autodesk.Windows.RibbonItem"/> from.</param>
    ...
    private static void OnApplicationThemeChanged(object? sender, PropertyChangedEventArgs args)
    {
        ...
        foreach (var button in _themedButtons)
        {
            ...
            if (button.LargeImage is not BitmapImage largeImage) continue;
            {
