...
/// <summary>
/// Converts <see cref="ExecutionMode"/> (or nullable ExecutionMode) to the matching icon ImageSource.
...
public sealed class ExecutionModeImageConverter : IValueConverter
{
    ...
    private static ResourceDictionary LoadIcons()
    {
        ...
        {
            Source = new Uri("/RevitDevTool;component/Theme/Styles/Icons.xaml", UriKind.Relative)
        };
        return dict;
    }
