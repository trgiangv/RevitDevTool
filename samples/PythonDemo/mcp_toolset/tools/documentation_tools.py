...
def register_documentation_tools(mcp: MCPServer) -> None:
    ...
    async def revit_create_view(
        ...
        level_name: Annotated[str | None, Field(description="Level name for plan views")] = None,
        view_name: Annotated[str | None, Field(description="View name")] = None,
        template_name: Annotated[str | None, Field(description="View template name")] = None,
        min_point: Annotated[list[float] | None, Field(description="Section box min [X,Y,Z] in feet")] = None,
        max_point: Annotated[list[float] | None, Field(description="Section box max [X,Y,Z] in feet")] = None,
        direction_angle: Annotated[float | None, Field(description="Section direction angle in degrees")] = None,
        depth: Annotated[float | None, Field()] = None,
        is_bounding_box: Annotated[bool | None, Field(description="Use bounding box for section")] = None,
    ) -> CreateViewResult:
    ...
    async def revit_create_sheet(
        title_block_id: Annotated[int | None, Field(description="Title block type id")] = None,
    ) -> CreateSheetResult:
    ...
    async def revit_place_on_sheet(
        ...
        view_or_schedule_id: Annotated[int, Field(description="View or schedule element id")],
    ...
    async def revit_apply_view_template(
        ...
        template_name: Annotated[str | None, Field(description="Template name; null detaches")] = None,
    ) -> ApplyViewTemplateResult:
    ...
    async def revit_list_views(
        include_sheets: Annotated[bool | None, Field(description="Include sheets")] = False,
        include_templates: Annotated[bool | None, Field(description="Include view templates")] = False,
    ) -> ListViewsResult:
