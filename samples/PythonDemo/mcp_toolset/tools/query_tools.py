...
def register_query_tools(mcp: FastMCP) -> None:
    ...
    async def revit_find_elements(
        ...
        limit: Annotated[int, Field(ge=1, le=10000)] = 200,
        offset: Annotated[int, Field(ge=0)] = 0,
        include_type: Annotated[bool, Field(alias="includeType")] = True,
        include_instance: Annotated[bool, Field(alias="includeInstance")] = True,
        ...
        return service.find_elements(
            ...
            include_instances=include_instance,
            max_results=limit,
            offset=offset,
            fields=fields,
        )
