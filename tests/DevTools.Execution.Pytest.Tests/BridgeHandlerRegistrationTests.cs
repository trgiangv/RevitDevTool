...
public sealed class BridgeHandlerRegistrationTests
{
    ...
    public void AddExecutionServices_and_AddNUnitHostServices_register_only_neutral_testing_methods()
    {
        ...
        Assert.Contains(PytestBridgeMethods.IpyTestsRun, methods, StringComparer.OrdinalIgnoreCase);
        ...
        Assert.AreEqual(methods.Count, methods.Distinct(StringComparer.OrdinalIgnoreCase).Count());
    }
