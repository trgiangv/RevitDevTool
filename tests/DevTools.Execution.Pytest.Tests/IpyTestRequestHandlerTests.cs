...
public sealed class IpyTestRequestHandlerTests
{
    ...
    public async Task UnknownMethod_ReturnsMethodNotFound()
    {
        ...
        var response = await handler.HandleAsync("1", "tests/run", null, TestContext.CancellationToken);
    ...
    public async Task InvalidParams_ReturnsPreparePhaseErrorResponse()
    {
        ...
        var response = await handler.HandleAsync("2", PytestBridgeMethods.IpyTestsRun, json, TestContext.CancellationToken);
