...
public sealed class DevToolsPipeServerTests
{
    ...
    {
        using var cts = CreateTimeoutCts(TestContext.CancellationToken);
    ...
    private static CancellationTokenSource CreateTimeoutCts(CancellationToken cancellationToken)
    {
