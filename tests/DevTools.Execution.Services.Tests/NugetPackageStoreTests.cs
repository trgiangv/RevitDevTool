...
public sealed class NugetPackageStoreTests
{
    ...
    public void List_ReturnsPackagesFromCacheFolders()
    {
        ...
        try
        {
            ...
            Assert.IsTrue(packages.Any(package => package.PackageId == packageId && package.Version == "9.9.9"));
        }
        finally
        {
    ...
    public async Task RemoveAsync_DeletesPackageFolder()
    {
        ...
        await store.RemoveAsync(package, TestContext.CancellationToken);
    ...
    public async Task UpdateAsync_ResolvesKnownPackage()
    {
        ...
        await store.UpdateAsync(package, TestContext.CancellationToken);
    }
    ...
    public async Task RepairAsync_RestoresKnownPackage()
    {
        ...
        await store.RepairAsync(package, TestContext.CancellationToken);
    }
