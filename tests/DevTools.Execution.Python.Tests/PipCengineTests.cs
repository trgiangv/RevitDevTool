...
public sealed class PipCengineTests
{
    ...
    public void SelectCengineDir_HostSidecar_SameVersionOnly()
    {
        ...
        try
        {
            Assert.AreEqual(cpy313, PipEnvironmentProvider.SelectCengineDir([cpy312, cpy313], "3.13"));
            Assert.IsNull(PipEnvironmentProvider.SelectCengineDir([cpy312], "3.13"));
            Assert.AreEqual(cpy312, PipEnvironmentProvider.SelectCengineDir([cpy312, cpy313], requiredVersion: null));
            ...
            Assert.IsNull(PipEnvironmentProvider.SelectCengineDir([forwarderOnly], "3.13"));
        }
        finally
        {
